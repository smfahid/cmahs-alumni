...
function EventCard({ event }: Readonly<{ event: Event }>) {
  return (
    <div className="bg-white rounded-xl shadow-soft overflow-hidden card-hover">
...
export function EventsSection({ events }: Readonly<{ events: Event[] }>) {
  // Get today's date at midnight for accurate comparison
  const { previousEvents, runningEvents, upcomingEvents } = useMemo(() => {
    ...
    return { previousEvents, runningEvents, upcomingEvents };
  }, [events]);
      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Join us at our events to connect with fellow alumni and stay engaged
            with our community.
          </p>
        </div>
          ...
          <TabsContent value="previous">
            {previousEvents.length === 0 ? (
              <div className="text-center text-gray-500 py-12 bg-white rounded-lg shadow-soft">
                ...
                <p>Check back later for past events.</p>
              </div>
            ) : (
          ...
          <TabsContent value="running">
            {runningEvents.length === 0 ? (
              <div className="text-center text-gray-500 py-12 bg-white rounded-lg shadow-soft">
                ...
                <p>Check the upcoming or previous tabs for other events.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
